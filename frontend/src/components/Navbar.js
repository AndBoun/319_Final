        ...
        <div className="row justify-content-between align-items-center w-100">
          <div className="col-auto">
            <Link className="navbar-brand text-white" to="/">
              <img
                src={`${process.env.PUBLIC_URL}/myotherimages/logo.png`}
                alt="logo"
                ...
                <ul className="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                  <li className="nav-item dropdown">
                    ...
                    >
                      ...
                      <li>
                        <Link to="/kai" className="dropdown-item item-anchor">
                          Kai Quach
                        </Link>
                      </li>
                    </ul>
                  ...
                  <li className="nav-item dropdown">
                    ...
                    >
                      ...
                      <li>
                        <Link to="/pants" className="dropdown-item item-anchor">
                          Pants
                        </Link>
                      </li>
                    </ul>
                  ...
                  <li className="nav-item dropdown">
                    ...
                    >
                      <li>
                        <Link to="/cart" className="dropdown-item item-anchor">
                          View Cart
                        </Link>
                      </li>
                      <li>
